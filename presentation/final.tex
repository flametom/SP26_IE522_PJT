...
\column{0.52\textwidth}
\begin{center}
\animategraphics[poster=30,controls,loop,width=0.7\linewidth]{6}{assets/frames_psuup/sim_}{000}{060}
\end{center}
...
\column{0.46\textwidth}
\begin{center}
\includegraphics[width=\linewidth]{../results/fig3_network_PSU-UP.png}\\[2pt]
...
\begin{center}
\animategraphics[poster=30,controls,loop,width=0.55\linewidth]{6}{assets/frames_cmp_pmax/cmp_}{000}{060}
\end{center}
...
\begin{center}
\animategraphics[poster=30,controls,loop,width=0.55\linewidth]{6}{assets/frames_cmp_panic/cmp_}{000}{060}
\end{center}
...
\begin{center}
\animategraphics[poster=30,controls,loop,width=0.55\linewidth]{6}{assets/frames_cmp_hmax/cmp_}{000}{060}
\end{center}
...
B1: Shelter-location sensitivity study & Partially done (see slide 15) --- extended sweep would strengthen it \\
