...
% ============================================================
\begin{frame}[t,shrink=10]{Engineering \textcircled{\scriptsize 5}: Benchmark --- na\"{i}ve vs optimized}
\footnotesize
...
\begin{center}
\animategraphics[poster=30,controls,loop,width=0.98\linewidth]{6}{assets/frames_psuup/sim_}{000}{060}
\end{center}
...
\begin{tikzpicture}[>=Stealth, font=\footnotesize, scale=0.95, transform shape]
  ...
  \node[panelbox, fill=lightbluefill, text width=4.2cm, align=left] (q1) at (-4.8, 0)
  ...
  \node[panelbox, fill=lightredfill, text width=4.2cm, align=left] (q2) at (0, 0)
  ...
  \node[panelbox, fill=lightgreenfill, text width=4.2cm, align=left] (q3) at (4.8, 0)
